...
#define NODE_MAIN_LOGGER_NAME "cam2image"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_tools.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_tools::Cam2Image>";
